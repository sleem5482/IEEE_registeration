...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState<Partial<RegisterFormData & { payment_image?: File | null }>>({
    nameAr: "",
    nameEn: "",
    phone: "",
    governorate: "",
    ...
    try {
      ...
      if (err instanceof ZodError) {
        ...
        err.errors.forEach((z) => {
          const field = z.path[0] as keyof RegisterFormData | undefined;
        ...
        <div className="form">
          ...
          {showSuccess ? (
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-bold text-green-400 mb-2">تم التسجيل بنجاح!</h2>
              <p className="text-white/80">شكرا علي التسجيل انت دلوقتي pending لحد ما يتم مراجعتك</p>
            </div>
          ) : (
              ...
              <div className="bus">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => {
                      setFormData((prev) => ({ ...prev, needsBus: e.target.checked }));
                      if (errors.needsBus) {
